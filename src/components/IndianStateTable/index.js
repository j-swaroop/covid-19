...
const IndianStateTable = props => {
  ...
  const {listOfPopulation, listOfOther, listOfDeceased, listOfConfirmed, stateName, stateCode, listOfRecovered} = state

  const active = listOfConfirmed - listOfRecovered - listOfDeceased -listOfOther
